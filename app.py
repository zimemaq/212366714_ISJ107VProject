...
results_df.columns = ['Index', 'Target variable', 'Score']
results_df = results_df[['Target variable', 'Score']]
...
threshold_df, metrics, metrics_default = get_metrics_df(results_df, threshold=threshold)
